...
public class MyPageServiceImpl implements MyPageService {
    ...
    public List<MyConsultationResponseDto> getMyConsultations(String userId) {
        ...
        return consultationRepository.findByUserIdOrderByCreatedAtDesc(user.getUserId()).stream()
                .filter(consultation -> !CONSULT_STATUS_CANCELED.equals(consultation.getConsultStatus()))
    ...
    public MyConsultationResponseDto getMyConsultationDetail(String userId, String consultId) {
        ...
        if (CONSULT_STATUS_CANCELED.equals(consultation.getConsultStatus())) {
    ...
    public List<MyInquiryResponseDto> getMyInquiries(String userId) {
        ...
        return inquiryRepository.findByUserIdOrderByCreatedAtDesc(user.getUserId()).stream()
                .filter(inquiry -> !INQUIRY_STATUS_CANCELED.equals(inquiry.getReplyStatus()))
    ...
    public MyInquiryResponseDto getMyInquiryDetail(String userId, String inquiryId) {
        ...
        if (INQUIRY_STATUS_CANCELED.equals(inquiry.getReplyStatus())) {
    ...
    public void cancelMyInquiry(String userId, String inquiryId) {
        ...
        if (!inquiry.getUserId().equals(user.getUserId())) {
            throw new IllegalArgumentException("본인의 문의만 취소할 수 있습니다.");
        }
