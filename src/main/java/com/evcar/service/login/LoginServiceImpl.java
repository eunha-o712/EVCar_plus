...
public class LoginServiceImpl implements LoginService {
    ...
    public void verifyUser(PasswordResetDto dto) {
        ...
        if (user.getUserStatus() == UserStatus.WITHDRAWN) {
            throw new IllegalArgumentException("탈퇴한 회원은 이용할 수 없습니다.");
        }
    }
    ...
    public String findUserLoginId(IdRecoveryDto dto) {
        ...
        if (user.getUserStatus() == UserStatus.WITHDRAWN) {
            throw new IllegalArgumentException("탈퇴한 회원은 아이디를 찾을 수 없습니다.");
        }
    ...
    public void resetPassword(PasswordResetDto dto) {
        ...
        if (user.getUserStatus() == UserStatus.WITHDRAWN) {
            throw new IllegalArgumentException("탈퇴한 회원은 비밀번호를 변경할 수 없습니다.");
        }
