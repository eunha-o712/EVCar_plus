...
public interface ConsultationRepository extends JpaRepository<Consultation, String> {
	...
	boolean existsByUserIdAndConsultStatusIn(String userId, List<String> statuses);
	...
	long countByConsultResultAndCreatedAtBetween(String consultResult, LocalDateTime startDateTime,
	...
	@Query(value = """
			...
			LIMIT 1
			""", nativeQuery = true)
	TopVehicleProjection findTopVehicleDemandStats(@Param("startDateTime") LocalDateTime startDateTime,
	...
	@Query(value = """
			...
			LIMIT 1
			""", nativeQuery = true)
	TopRegionProjection findTopRegionConsultationStats(@Param("startDateTime") LocalDateTime startDateTime,
			@Param("endDateTime") LocalDateTime endDateTime);
